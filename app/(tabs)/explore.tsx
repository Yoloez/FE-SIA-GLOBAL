  ...
  return (
    <ParallaxScrollView headerBackgroundColor={{ light: "#D0D0D0", dark: "#353636" }} headerImage={<IconSymbol size={310} color="#808080" name="chevron.left.forwardslash.chevron.right" style={styles.headerImage} />}>
      ...
      <Collapsible title="Animations">
        <ThemedText>
          This template includes an example of an animated component. The <ThemedText type="defaultSemiBold">components/HelloWave.tsx</ThemedText> component uses the powerful{" "}
      ...
      <Link href="/" asChild>
        <View className="mt-6 px-6 py-3 rounded-md self-center bg-cyan-400/20 border border-cyan-400 active:scale-95">
          <Text className="text-white text-2xl font-bold">Back to index</Text>
        </View>
      </Link>
    </ParallaxScrollView>
  );
